...
-- Davis Thomas'nin calistigi magazadaki tum personelleri listeleyin.
...
-- Charles	Cussona 'in yoneticisi oldugu personelleri listeleyin.
...
-- 'The BFLO Store' isimli magazanin bulundugu sehirdeki musterileri listeleyin.
...
-- 'Pro-Series 49-Class Full HD Outdoor LED TV (Silver)' isimli urunden pahali olan Televizyonlari listeleyin.

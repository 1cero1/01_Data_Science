...
select * 
into Person.Person2 
from Person.Person-- Person_2 şeklinde yedek bir tablo oluşturuyouruz burada


INSERT Person.Person2 (SSN, Person_FirstName, Person_LastName)
...
SET Person_FirstName = 'Default_Name'--burayı çalıştırmadan önce yukarıdaki scripti çalıştırın
...
DROP TABLE Person.Person2;--Artık ihtiyacımız yok.
